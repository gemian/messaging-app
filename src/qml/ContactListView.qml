...
FocusScope {
    ...
    */
    property bool showImportFromAccountOption: false//buteoSync.serviceAvailable
    ...
    */
    readonly property bool syncing: false//buteoSync.syncing || Contacts.Contacts.updateIsRunning
    /*!
