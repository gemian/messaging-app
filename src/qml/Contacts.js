...
function getFavoritePhoneLabel(contact, defaultValue)
{
    ...
    if (!phoneTypeModel) {
        phoneTypeModel = Qt.createQmlObject("ContactDetailPhoneNumberTypeModel {}",
                                            parent,
...
{
    var r = Math.floor(Math.random()*contactColors.length);
    return contactColors[(r % contactColors.length)]
}
